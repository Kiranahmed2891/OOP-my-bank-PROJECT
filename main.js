...
// create customers 
const customers = [
    new Customer("Abdullah", "Khan", "Male", 35, 3166783676, accounts[0]),
    new Customer("Hina", "naseer", "Female", 36, 3336783676, accounts[1]),
    new Customer("kiran", "ahmed", "Female", 30, 3416783676, accounts[2])
];
